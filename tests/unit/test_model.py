...
def test_get_pref_label_language_exists(concept_scheme: ConceptScheme) -> None:
...
def test_get_pref_label_language_does_not_exist(concept_scheme: ConceptScheme) -> None:
...
def test_get_pref_label_no_language_specified(concept_scheme: ConceptScheme) -> None:
...
def test_get_pref_label_no_language_specified_no_english(
...
def test_get_pref_label_language_exists_concept(concept: Concept) -> None:
    """It should return the preferred label in the specified language."""
    assert concept.get_pref_label("sk") == "0203 21 -- Trupy a polovičky trupov"


def test_get_pref_label_language_does_not_exist_concept(concept: Concept) -> None:
    """It should return the preferred label in English if the specified language does
    not exist."""
    assert concept.get_pref_label("fr") == "0203 21 -- Carcases and half-carcases"


def test_get_pref_label_no_language_specified_concept(concept: Concept) -> None:
    """It should return the preferred label in English if no language is specified."""
    assert concept.get_pref_label() == "0203 21 -- Carcases and half-carcases"


def test_get_pref_label_no_language_specified_no_english_concept(
    concept: Concept,
) -> None:
    """It should return an empty string if no language is specified and English does
    not exist."""
...
def test_get_alt_label_language_exists_concept(concept: Concept) -> None:
    """It should return the alternative label in the specified language."""
    assert concept.get_alt_label("sk") == "-- Trupy a polovičky trupov"


def test_get_alt_label_language_does_not_exist_concept(concept: Concept) -> None:
...
def test_get_alt_label_no_language_specified_concept(concept: Concept) -> None:
...
def test_get_alt_label_no_language_specified_no_english_concept(
    concept: Concept,
) -> None:
    """It should return an empty string if no language is specified and English does
    not exist."""
...
def test_get_scope_note_language_exists_concept(concept: Concept) -> None:
...
def test_get_scope_note_language_does_not_exist_concept(concept: Concept) -> None:
...
def test_get_scope_note_no_language_specified_concept(concept: Concept) -> None:
...
def test_get_scope_note_no_language_specified_no_english_concept(
    concept: Concept,
) -> None:
    """It should return an empty string if no language is specified and English does
    not exist."""
